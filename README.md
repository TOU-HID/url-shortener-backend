...
- MongoDB (Community Edition 7.0) [[Setup Guide]](https://www.mongodb.com/docs/v7.0/administration/install-community/)
- npm (Usually comes with node.js)

### 1.2 Getting Started

#### 1.2.1 Configure backend server

- **If mongodb is not running, start mongodb:**
...
- **Clone the repository:**
  ...
  ```bash
  git clone https://github.com/TOU-HID/url-shortener-backend.git
  ```
...
#### 1.2.2 Configure frontend server

The frontend is hosted in another repository, [please click this link](https://github.com/TOU-HID/url-shortener-frontend) and follow the setup guide.
...
_All these endpoints require the `Authorization: Bearer <token>` header._
